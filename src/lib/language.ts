...
export const UI_DICTIONARY: Record<string, Partial<Record<string, string>>> = {
  ...
  allOfferings: { en: 'All Offerings', es: 'Todas las ofertas', fr: 'Toutes les offres', de: 'Alle Angebote', it: 'Tutte le offerte', pt: 'Todas as ofertas', ja: 'すべての提供', ko: '모든 제공', ar: 'كل العروض', hi: 'सभी ऑफर', bn: 'সব অফার', tr: 'Tum teklifler' },
