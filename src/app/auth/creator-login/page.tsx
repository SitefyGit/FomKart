...
export default function CreatorLogin() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.user) {
        // Check if user is a creator and get their profile
        ...
        if (!userProfile.is_creator) {
          setError('This account is not registered as a creator')
          setIsLoading(false)
          return
        }

        // Successful creator login
        router.push(`/creator/${userProfile.username}`)
      }
    } catch (err) {
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <Link href="/" className="inline-flex items-center space-x-2 mb-6">
            ...
            <span className="text-2xl font-bold text-gray-900">FomKart</span>
          </Link>
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full bg-emerald-600 hover:bg-emerald-700 disabled:bg-emerald-400 text-white font-semibold py-3 px-4 rounded-lg transition-colors flex items-center justify-center space-x-2"
            >
              {isLoading ? (
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-600">
              ...
              <Link href="/auth/creator-signup" className="text-emerald-600 hover:text-emerald-500 font-medium">
                Sign up as creator
              </Link>
            </p>
          </div>
